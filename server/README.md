...
node seedDb.js 
  ...
  - Users passwords are hashed in the database for security reasons. Current saved users from seedDb script (wiresample, deltasoldier) have password "wirepass". New users can be created using the router with passport registration ('/register') using postamn or other methods of http requests.
